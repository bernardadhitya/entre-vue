<template>
    <v-container>
        ...
        <v-layout column>
            ...
            <v-flex xs12>
                <p>Find venues to partner up for your event</p>
            </v-flex>
        </v-layout>
        <v-layout column>
    ...
    data(){
        return{
            items: [
                { 
                    id: 1,
                    name: "B'Steak Grill & Pancake", 
                    job: "Venue",
                    price: 9500000  ,
                    imageUrl: "https://scontent-sin6-1.cdninstagram.com/vp/78e7cfad83921b878e2a547388d4cdb1/5C81E126/t51.2885-19/s320x320/21041608_1434636509934930_3577484904599912448_a.jpg",
                    color: "red"
                },
                { 
                    id: 2,
                    ...
                    job: "Venue",
                    price: 13000000  ,
                    imageUrl: "https://s.kaskus.id/images/2012/09/21/2267365_20120921094638.jpg",
                    color: "black"
                }
            ],
