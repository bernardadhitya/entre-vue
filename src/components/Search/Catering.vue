<template>
    <v-container>
        ...
        <v-layout column>
            ...
            <v-flex xs12>
                <p>Find caterings to partner up for your event</p>
            </v-flex>
        </v-layout>
        <v-layout column>
        ...
        return{
            items: [
                { 
                    ...
                    job: "Catering",
                    price: 3000000  ,
                    imageUrl: "https://gorrygourmet.com/assets/images/logo.png",
                    color: "orange"
                },
                { 
                    id: 2,
                    ...
                    job: "Catering",
                    price: 2500000  ,
                    imageUrl: "https://www.berrykitchen.com/new/2/assets/uploads/logo.png",
                    color: "yellow"
                }
            ],
